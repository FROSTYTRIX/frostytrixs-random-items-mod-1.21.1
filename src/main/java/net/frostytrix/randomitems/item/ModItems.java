...
public class ModItems {
    ...
    public static final Item STONE_SHOVEL_FLAIL = registerItem("stone_shovel_flail", new StoneShovelFlailItem(ToolMaterials.STONE, new Item.Settings()
            .attributeModifiers(StoneShovelFlailItem.createAttributeModifiers(ToolMaterials.STONE, 2.5f, -2.4f))));
